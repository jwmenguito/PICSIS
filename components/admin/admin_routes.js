...
module.exports = (router) =>{
    ...
    router.get('/admin/section',admin.admin_records);
    router.get('/admin/section/create/get/list',admin.admin_section_get_listing);
    ...
    router.post('/admin/term/end',admin.admin_term_end);
